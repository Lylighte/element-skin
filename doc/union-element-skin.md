...
### v2.4.0-union-b4（2026-06-11）

**上游合并与搜索功能增强**：合并 upstream/water2004:main 变更，升级至 v2.4.0 基线。新增公开皮肤库按名称、哈希、上传者搜索功能（支持名称模糊、哈希精确、上传者组合查询），私有材质自动排除。新增 Authlib-Injector ALI 支持。

**文档更新**：重写版本历史结构化章节，修复行号与 typo，新增 union-2.4.0 构建说明。
