...
func TestMicrosoftHTTPClientExchangeCodeRequestShape(t *testing.T) {
	...
	client := service.MicrosoftHTTPClient{
...
func TestMicrosoftHTTPClientProfile404ReturnsNilProfile(t *testing.T) {
	client := service.MicrosoftHTTPClient{Client: &http.Client{Transport: roundTripFunc(func(req *http.Request) (*http.Response, error) {
...
func TestMicrosoftHTTPClientRejectsMalformedXboxAndMinecraftResponses(t *testing.T) {
	xboxClient := service.MicrosoftHTTPClient{Client: &http.Client{Transport: roundTripFunc(func(req *http.Request) (*http.Response, error) {
	...
	minecraftClient := service.MicrosoftHTTPClient{Client: &http.Client{Transport: roundTripFunc(func(req *http.Request) (*http.Response, error) {
