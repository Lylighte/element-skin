...
export function getUserPermissions(userId: string): Promise<{ data: UserPermissionsResponse }> {
  return client.get(`/admin/users/${userId}/permissions`)
}
...
export function grantUserRole(
  ...
  return client.put(`/admin/users/${userId}/roles/${roleId}`)
}
...
export function setUserPermissionOverride(
  ...
  return client.put(`/admin/users/${userId}/permissions/${permissionCode}`, { effect })
}
...
export function clearUserPermissionOverride(
  ...
  return client.delete(`/admin/users/${userId}/permissions/${permissionCode}`)
}
